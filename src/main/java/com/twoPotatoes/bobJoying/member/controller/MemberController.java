...
import com.twoPotatoes.bobJoying.member.dto.LoginResponseDto;
...
public class MemberController {
    ...
    @MutationMapping
    public LoginResponseDto login(@Argument @Valid LoginRequestDto loginRequestDto) {
        String token = memberService.login(loginRequestDto);
        return new LoginResponseDto(token, "로그인이 완료되었습니다.");
    }

    // TODO: 로그인 메서드 구현 후 테스트로 만든 메서드들. 후에 삭제
    @QueryMapping
